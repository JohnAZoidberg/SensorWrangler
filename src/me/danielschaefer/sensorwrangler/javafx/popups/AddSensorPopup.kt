...
class AddSensorPopup(val parentStage: Stage, val sensorTab: SensorTab? = null) : Stage() {
    ...
    private var currentSensor: KClass<out VirtualSensor>? = null
    ...
    private fun addSensor(selectedSensor: KClass<out VirtualSensor>, propertyMap: MutableMap<KMutableProperty<*>, () -> Any?>): Boolean {
